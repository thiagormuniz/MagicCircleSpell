	...
	public sealed class OutlineNode : ParentNode
	{
		...
		public override void PropagateNodeData( NodeData nodeData, ref MasterNodeDataCollector dataCollector )
		{
			...
			if( !dataCollector.IsTemplate )
			{
				...
				UIUtils.CurrentWindow.OutsideGraph.CurrentStandardSurface.OutlineHelper.ZClipMode = m_zClipMode;
		...
		public override void DrawProperties()
		{
			...
			NodeUtils.DrawPropertyGroup( ref m_propertiesFoldout, Constants.ParameterLabelStr, () =>
			{
				...
				m_zClipMode = EditorGUILayoutPopup( ZBufferOpHelper.ZClipModeStr, m_zClipMode, ZBufferOpHelper.ZClipModeValues );
		...
		public override void ReadFromString( ref string[] nodeParams )
		{
			...
			{
				m_zClipMode = Convert.ToInt32( GetCurrentParam( ref nodeParams ) );
			}
		...
		public override void WriteToString( ref string nodeInfo, ref string connectionsInfo )
		{
			...
			IOUtils.AddFieldValueToString( ref nodeInfo, m_zClipMode );
		}
	}
}
